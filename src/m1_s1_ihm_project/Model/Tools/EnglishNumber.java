...
public class EnglishNumber extends RecursiveTreeObject<EnglishNumber>{
    ...
    public EnglishNumber(String number, String numberEn, String ordinal, String ordinalEn) {
        this.number = number;
